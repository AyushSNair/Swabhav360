...
const AttendanceTracker: React.FC<AttendanceTrackerProps> = ({ selectedClass, onBack, onSave }) => {
  ...
  const renderStudentItem = ({ item, index }: { item: Student; index: number }) => (
    <View style={styles.studentCardModern}>
      <LinearGradient
      ...
      <View style={styles.studentInfoModern}>
        <Text style={styles.studentNameModern}>{`🧑‍🎓 ${item.name}`}</Text>
      </View>
      <TouchableOpacity
        style={[
          styles.attendanceToggle,
          attendance[item.id] ? styles.presentToggle : styles.absentToggle
        ]}
      ...
      >
        ...
        <Text style={[
          ...
          attendance[item.id] ? styles.presentToggleText : styles.absentToggleText
        ]}>
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={styles.container}>
        ...
        <View style={styles.classInfoCard}>
          ...
          <View style={styles.datePickerModern}>
            <Text style={styles.dateLabelModern}>Date</Text>
            <TouchableOpacity onPress={() => setShowDatePicker(true)} style={styles.dateButtonModern}>
              <MaterialIcons name="calendar-today" size={20} color="#4F46E5" />
              <Text style={styles.dateTextModern}>{selectedDate.toDateString()}</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <View style={styles.buttonRowModern}>
            <TouchableOpacity style={styles.backButtonModern} onPress={onBack}>
              <MaterialIcons name="arrow-back" size={20} color="#fff" />
              <Text style={styles.backButtonTextModern}>⬅️ Back</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.saveButtonModern} onPress={handleSave} disabled={loading}>
              <MaterialIcons name="save" size={20} color="#fff" />
              <Text style={styles.saveButtonTextModern}>{loading ? 'Saving...' : 'Save Attendance ✅'}</Text>
            </TouchableOpacity>
          </View>
        </View>
